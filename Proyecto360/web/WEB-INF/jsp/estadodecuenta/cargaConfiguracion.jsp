<%-- 
    Document   : cargaConfiguracion
    Created on : 05-ene-2016, 22:21:28
...
<div class="col-lg-12">
    <div class="main-box clearfix">
        ...
        <div class="col-lg-12">
            ...
            <h3 style="margin-top: 5px; margin-left: 10px"><span>Resultado de la operaci&oacute;n de carga</span></h3>
            ...
            <div class="clearfix">&nbsp;</div> 
            <div class="clearfix">&nbsp;</div> 
            <form id="revertir" action="/upload/revertirCargosMasivos.action" method="post" >
