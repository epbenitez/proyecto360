<%-- 
    Document   : cargos
    Created on : 04-ene-2016, 10:36:00
...
//                var table = $('#configuracion').DataTable();
//                if (!table.data().count()) {
////                    alert('Empty table');
//                }
        ...
        function configuracionInicial() {
            ...
            table = $('#configuracion').DataTable({
                "ajax": '/ajax/configuracionInicialMasivosAjax.action?cargo=true&condominioId=' + $('#condominioId').val(),
                "order": [],
                "columnDefs": [{
                        "targets": 'no-sort',
                        "orderable": false,
        ...
        function limpiaConfiguracion() {
            $.ajax({
                type: 'POST',
                url: '/ajax/limpiaConfiguracionMasivosAjax.action?cargo=true&condominioId=' + $('#condominioId').val(),
                dataType: 'json',
                cache: false,
        ...
        function reload() {
            ...
            table = $('#configuracion').DataTable({
                "ajax": '/ajax/configuracionMasivosAjax.action?cargo=true&condominioId=' + $('#condominioId').val()
...
<s:form id="cargaForm" action="cargaConfiguracionMasivos.action" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-lg-12">
        <div class="main-box clearfix">
            ...
            <div class="col-lg-12">
                ...
                <h3 style="margin-top: 5px; margin-left: 10px"><span>Configuraci&oacute;n de Cargos</span></h3>
                <div class="col-md-2">
    ...
    <div class="col-md-6">
        <div class="main-box clearfix">
            ...
            <div class="clearfix">&nbsp;</div>  
            <div class="col-md-2">
                <label for="maskedDate">Fecha de cargo (Periodo):</label>
            </div>
            <div class="col-md-10">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
