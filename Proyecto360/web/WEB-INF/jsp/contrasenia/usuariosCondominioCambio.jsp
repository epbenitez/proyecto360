<%-- 
    Document   : usuariosCondominioForm
    Created on : 12-oct-2016, 21:47:08
                ...
                <div class="col-lg-12">
                    <div class="main-box clearfix" >
                        <div class="main-box-body ">
                            <form id="passwordForm" method="post" class="form-horizontal" action="/admin/usuarios/usuariosCondominioActualizaAdministracion.action" style="margin-top: 20px;">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Usuario</label>
                                    <div class="col-lg-8">
                                        <s:textfield name="usr.usuario" />
                                        </div>
