<%-- 
    ...
    Created on : 14-feb-2017, 16:17:41
...
//            $("body").removeClass("boxed-layout");
        ...
        function reload() {
            ...
            var url = "/ajax/getListaGruposNotificacionesAjax.action";

            url = url + "?condominioId=" + condominio + "&grupo.nombre=" + $('#nombre').val();
...
<div class="container">
    <p></p>
    <h1>Gesti&oacute;n de Grupos para Notificaciones</h1>
            ...
            <form id="filtro" name="filtro">
                <div class="form-group">
                    <div class="col-lg-12 text-left ">
                        <a href="/notificaciones/grupos/altaGruposNotificaciones.action" id="nuevo" class="btn btn-success fancybox fancybox.iframe">Nuevo Grupo</a>
                    </div>
                    <div>&nbsp;</div>
                </div>
                <security:authorize ifAnyGranted="ROLE_ADMIN">
