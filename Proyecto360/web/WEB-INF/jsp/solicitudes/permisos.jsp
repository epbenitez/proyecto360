<%-- 
    Document   : permisos
    Created on : 17-mar-2016, 12:42:24
...
<head>
    ...
    <script type="text/javascript" language="javascript" class="init">
        ...
        function agregar() {
            ...
            var tipoSolicitud = ($('#tipoSolicitud').val() === null) ? "" : $('#tipoSolicitud').val();
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax/agregaPermisoSolicitudesAjax.action',
                dataType: 'json',
                data: {
                    pkCondominio: condominio,
                    pkUsuario: usuario,
                    pkTipo: tipoSolicitud,
...
//                    alert(aData.data[0]);
        ...
        function reload() {
            ...
            if (condominio === "") {
                BootstrapDialog.show({
                    title: 'Atención',
                    message: 'Es necesario especificar por lo menos el condominio para poder realizar una búsqueda. Por favor, verifique.'
                });
            } else {
