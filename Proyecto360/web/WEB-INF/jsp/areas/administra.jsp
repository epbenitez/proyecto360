<%-- 
    Document   : administra
    Created on : 16-sep-2016, 10:45:16
...
//            } else {
                ...
                var url = "/ajax/getAreasAreasAjax.action";
...
<div class="container">
    <p></p>
    <h1>Administraci&oacute;n de &Aacute;reas</h1>
    ...
    <div class="row main_content">
        ...
        <div class="row col-lg-12 main-box" id="busquedaForm">
            ...
            <h2 style="margin-left: 10px" >Seleccione Condominio y  Torre para encontrar las &aacute;reas correspondientes.</h2>
            <div class="clearfix" >&nbsp;</div>
            <form id="filtro" name="filtro">
                <div class="form-group">
                     <div class="col-lg-12 text-left ">
                         <a href="/areas/altaArea.action" id="nuevo" class="btn btn-success fancybox fancybox.iframe">Agregar &Aacute;rea</a>
                    </div>
                    <div>&nbsp;</div>
                </div>
                <security:authorize ifAnyGranted="ROLE_ADMIN">
                ...
                <div class="form-group">
                    <div class="col-lg-12 text-center ">
                        ...
                        <button type="submit" id="buscar" class="btn btn-success">Ver &Aacute;reas</button>
                    </div>
                </div>
                <div class="clearfix" >&nbsp;</div>
            </form>
                    ...
                    <table id="listado" class="table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>&Aacute;rea</th>
                                <th>Max. Personas</th>
                                <th>Corriente en Pagos</th>
                                <th>M&aacute;x. d&iacute;s</th>
                                <th>Min. d&iacute;s</th>
                                <th>Unidad</th>
                                <th>Renta</th>
                                <th>Dep&oacute;sito de Garant&iacute;a</th>
                                <th width="5%"></th>
                            </tr>
                        </thead>
                    </table>
