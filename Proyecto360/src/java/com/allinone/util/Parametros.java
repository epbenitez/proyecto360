...
/**
 * Clase para leer los parámetros de configuración del sistema. Los parámetros son valores
 * constantes que apoyan la implementación de reglas de negocio. El valor de los parámetros se
 * definen en el archivo Parametros .
 *
 */
public class Parametros {
    ...
    /**
     * Obtiene el valor como cadena de un parámetro que corresponda con el nombre proporcionado
     * @param prop Nombre de la propiedad
     * @return Valor de la propiedad
     */
    ...
    /**
     * Obtiene el valor como entero de un parámetro que corresponda con el nombre proporcionado
     * @param prop Nombre de la propiedad
     * @return Valor de la propiedad
     */
    ...
    /**
     * Obtiene el valor como double de un parámetro que corresponda con el nombre proporcionado
     * @param prop
     * @return Valor de la propiedad
     */
    ...
    /**
     * Obtiene el valor como boolean de un parámetro que corresponde con el nombre proporcionado
     * @param prop
     * @return
     */
