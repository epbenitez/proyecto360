...
/**
 * Implementa operaciones de lógica de negocio para la consulta del Historial de cambios
 *
...
public class BitacoraBO extends BaseBO {
    ...
    /**
     * Registra los movimientos de creación, modificación o borrado de un objeto del sistema. Se guarda el estado
     * anterior del objeto si existe y el nuevo objeto
    ...
    public void saveBitacora(Usuario user, String object, String objectId, String descripcion, Accion accion) {
        ...
        service.getBitacoraDao().save(bitacora);
    }
