...
/**
 * Implementación de las operaciones CRUD de la bitácora de modificaciones del sistema (auditoria)
 *
 * Todos los cambios de Alta, Modificación o Baja de los objetos del sistema son registrados. Las
 * pantallas de consulta, solo explotan información relativa a los Alumnos y Personal Académico
 * pero podrían consultarse cambios realizados en cualquier que haya sido persistido por el sistema.
 * 
 * @author Patricia Benitezópez <yolanda.lopez@fit.com.mx>
 * @version $Rev: 1169 $
 * @since 1.0
 */
public class BitacoraJpaDao extends JpaDaoBitacora<Bitacora, Long> implements BitacoraDao {
    ...
    /**
     * Obtiene los movimientos de creación, modificación o borrado que se hayan sido realizados sobre un objeto
     * en base a los criterio releccionados
     *
     * @param objetos Tipo de objeto sobre el que se quieren ver los movimientos (Alumno,Tutor,Facilitador)
     * @param fechaIni Rango inicial para la búsqueda que será comparada con la fecha de ejecución del movimiento
     * @param fechaFin Rango final para la búsqueda que será comparada con la fecha de ejecución del movimiento
